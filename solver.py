    ...
    def test(self):
        ...
        for i, data_batch in enumerate(self.test_loader):
            ...
            with torch.no_grad():
                ...
                preds,rgb_enc,depth_enc = self.net(images,depth)
    ...
    def train(self):
        ...
        for epoch in range(self.config.epoch):
            ...
            for i, data_batch in tqdm(enumerate(self.train_loader)):
                ...
                sal_final,rgb_en1,depth_en1= self.net(sal_image,sal_depth)
                ...
                sal_rgb_only_loss = sal_loss_final + sal_loss_rgb/2 + sal_loss_depth/2
